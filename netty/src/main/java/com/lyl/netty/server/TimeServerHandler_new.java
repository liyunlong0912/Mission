 ...
 */
public class TimeServerHandler_new extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println((atomicInteger.addAndGet(1)) + "--->" + Thread.currentThread().getName() + ",The server " +
                "receive  order : " + body);
         ...
         * windows 系统上回车换行符 "\n",Linux 系统上是 "/n"
         * */
        String respMsg = "I am Server，消息接收 success!" + Thread.currentThread().getName() + System.getProperty("line" +
                ".separator");
