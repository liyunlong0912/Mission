 ...
 * 用于对网络事件进行读写操作
 */
public class TimeClientHandler_new extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        for (int i = 0; i < 50; i++) {
             ...
             * windows 系统上回车换行符 "\n",Linux 上是 "/n"
             */
            String reqMsg = (i + 1) + ",我是客户端 " + Thread.currentThread().getName() + System.getProperty("line" +
                    ".separator");
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        System.out.println((atomicInteger.addAndGet(1)) + "---" + Thread.currentThread().getName() + ",Server return " +
                "Message：" + body);
    }
