...
public class UdpServer implements Runnable {
    ...
    private class Client extends Thread {
        ...
        private gabrielleopoldino.jsse.DTLSNonBlocking.Buffers buffers;
        private gabrielleopoldino.jsse.DTLSNonBlocking.SSLManager sslManager;


        public Client(SocketAddress address) throws IOException {
            this.address = address;
            this.in = new LinkedBlockingQueue<>();
            this.sslEngine = gabrielleopoldino.jsse.DTLSNonBlocking.UdpCommon.getContext().createSSLEngine();
            this.sslEngine.setNeedClientAuth(false);
            this.sslEngine.setUseClientMode(false);

            this.sslSession = this.sslEngine.getSession();

            this.buffers = new gabrielleopoldino.jsse.DTLSNonBlocking.Buffers(this.sslSession.getApplicationBufferSize(),
                    this.sslSession.getPacketBufferSize());

            gabrielleopoldino.jsse.DTLSNonBlocking.SSLManager.IO io = new gabrielleopoldino.jsse.DTLSNonBlocking.SSLManager.IO() {
                @Override
            ...
            this.sslManager = new gabrielleopoldino.jsse.DTLSNonBlocking.SSLManager(io, sslEngine, buffers);
        }
